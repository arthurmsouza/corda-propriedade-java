...
public class InicializaPropriedadeFlow extends FlowLogic<SignedTransaction> {
    ...
    private static final ProgressTracker.Step GERANDO_TRASACAO = new ProgressTracker.Step("Gerando a transacao");
    ...
    public SignedTransaction call() throws FlowException {
        ...
        progressTracker.setCurrentStep(GERANDO_TRASACAO);
